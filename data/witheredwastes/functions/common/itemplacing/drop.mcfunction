...
execute as @e[type=item,nbt={Tags:["ww.common.item_display.dropped"],Item:{id:"minecraft:enchanted_book",Count:1b}}] unless data entity @s Item.tag.StoredEnchantments run kill @s
