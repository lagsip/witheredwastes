...
execute store result entity @e[type=item,tag=ww.unassigned,sort=nearest,limit=1] Item.tag.ww_ccycle byte 1 run scoreboard players get #witheredwastes ww.ccycle
