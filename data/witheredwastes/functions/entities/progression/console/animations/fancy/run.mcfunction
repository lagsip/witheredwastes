...
execute unless data block ~ ~ ~ Book.tag.Console.Animation[0] unless score @s ww.console.task > #0 constant run function witheredwastes:entities/progression/console/animations/fancy/continue
